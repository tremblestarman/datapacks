...
execute if block ~ ~ ~1 minecraft:torch run tag @s add explode
execute if block ~ ~ ~-1 minecraft:torch run tag @s add explode
execute if block ~ ~ ~ minecraft:wall_torch run tag @s add explode
execute if block ~ ~1 ~ minecraft:wall_torch run tag @s add explode
execute if block ~ ~-1 ~ minecraft:wall_torch run tag @s add explode
execute if block ~1 ~ ~ minecraft:wall_torch run tag @s add explode
execute if block ~-1 ~ ~ minecraft:wall_torch run tag @s add explode
execute if block ~ ~ ~1 minecraft:wall_torch run tag @s add explode
...
execute if block ~ ~ ~1 minecraft:furnace[lit=true] run tag @s add explode
execute if block ~ ~ ~-1 minecraft:furnace[lit=true] run tag @s add explode
execute as @s[tag=explode] run function 3mg:functional/gas/gas_explosion
