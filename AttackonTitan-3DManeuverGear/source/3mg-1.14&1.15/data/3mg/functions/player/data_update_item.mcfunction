...
execute as @e[type=item,nbt={Item:{tag:{3mgisUsing:1b}}},distance=..1,sort=nearest,limit=1] run data modify entity @s Item.tag.AttributeModifiers set value [{AttributeName:"generic.attack_damage",Name:"disable_attack",Amount:-100000,Operation:2,UUIDMost:41580,UUIDLeast:128196}]
