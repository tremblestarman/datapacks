...
execute at @a facing entity @e[tag=string_lm,limit=1] feet run function 3mg:player/function/drawstring_l
execute if entity @s[tag=3mg_hit_l] if score @s cStringLengthL > @s lStringLengthL run function 3mg:player/function/takeback_l
execute if entity @s[tag=3mg_hit_l] if score @s cStringLengthL <= @s lStringLengthL run scoreboard players operation @s lStringLengthL = @s cStringLengthL
