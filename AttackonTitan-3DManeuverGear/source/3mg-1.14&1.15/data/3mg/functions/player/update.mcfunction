...
# on fly
execute as @s[tag=!3mg_flying,scores={playerAir=1..},nbt={RootVehicle:{Entity:{Tags:[3mg_fly],id:"minecraft:pig",Health:0.1f}}}] at @s positioned ~ ~1.17 ~ positioned ^ ^ ^1.8 as @e[tag=3mg_fly,sort=nearest,limit=1,distance=..0.1] run function 3mg:player/physic/clear_noai_nogravity
...
execute as @s[tag=3mg_flying,tag=3mg_hit_l] run function 3mg:player/physic/add_force
execute as @s[tag=3mg_flying,tag=3mg_hit_r] run function 3mg:player/physic/add_force
