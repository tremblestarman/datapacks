...
# mainhand weapon
data modify entity @e[type=item,sort=nearest,limit=1,tag=3mg_disassemble] Item set from block ~ ~ ~ Items[{Slot:3b}].tag.MainHandWeapon
tag @e[tag=3mg_disassemble] remove 3mg_disassemble

summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:stone",Count:1b},Tags:[3mg_disassemble]}
# offhand weapon
data modify entity @e[type=item,sort=nearest,limit=1,tag=3mg_disassemble] Item set from block ~ ~ ~ Items[{Slot:3b}].tag.OffHandWeapon
tag @e[tag=3mg_disassemble] remove 3mg_disassemble

summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:stone",Count:1b},Tags:[3mg_disassemble]}
# compressed gas
data modify entity @e[type=item,sort=nearest,limit=1,tag=3mg_disassemble] Item set from block ~ ~ ~ Items[{Slot:3b}].tag.CompressedGas
execute store result score mb var run data get block ~ ~ ~ Items[{Slot:3b}].tag.CompressedGas.tag.MB
...
summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:stone",Count:1b},Tags:[3mg_disassemble]}
# compressed air
data modify entity @e[type=item,sort=nearest,limit=1,tag=3mg_disassemble] Item set from block ~ ~ ~ Items[{Slot:3b}].tag.CompressedAir
execute store result score mb var run data get block ~ ~ ~ Items[{Slot:3b}].tag.CompressedAir.tag.MB
execute if score mb var matches ..0 as @e[tag=3mg_disassemble,sort=nearest,limit=1] run data remove entity @s Item.tag.display.Lore
execute if score mb var matches ..0 as @e[tag=3mg_disassemble,sort=nearest,limit=1] run data modify entity @s Item.tag.MB set value 0
...
summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:stone",Count:1b},Tags:[3mg_disassemble]}
# core
data modify entity @e[type=item,sort=nearest,limit=1,tag=3mg_disassemble] Item set from block ~ ~ ~ Items[{Slot:3b}].tag.Core
tag @e[tag=3mg_disassemble] remove 3mg_disassemble
