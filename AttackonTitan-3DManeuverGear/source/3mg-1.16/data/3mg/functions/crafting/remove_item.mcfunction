...
execute store result score item_count var run data get block ~ ~ ~ Items.[{Slot:5b}].Count
scoreboard players remove item_count var 1
execute store result block ~ ~ ~ Items.[{Slot:5b}].Count byte 1 run scoreboard players get item_count var
execute store result score item_count var run data get block ~ ~ ~ Items.[{Slot:6b}].Count
scoreboard players remove item_count var 1
execute store result block ~ ~ ~ Items.[{Slot:6b}].Count byte 1 run scoreboard players get item_count var

execute store result score item_count var run data get block ~ ~ ~ Items.[{Slot:7b}].Count
scoreboard players remove item_count var 1
execute store result block ~ ~ ~ Items.[{Slot:7b}].Count byte 1 run scoreboard players get item_count var

execute store result score item_count var run data get block ~ ~ ~ Items.[{Slot:8b}].Count
scoreboard players remove item_count var 1
execute store result block ~ ~ ~ Items.[{Slot:8b}].Count byte 1 run scoreboard players get item_count var
