...
execute if entity @s[tag=!3mg_left_attached,tag=!3mg_right_attached] run scoreboard players set @s acceleration 20
execute if entity @s[tag=!3mg_left_attached,tag=!3mg_right_attached] run scoreboard players operation @s playerGas -= air_consume con
