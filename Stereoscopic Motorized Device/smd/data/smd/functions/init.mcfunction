...
scoreboard objectives add place_iron_block minecraft.used:minecraft.iron_block
scoreboard objectives add place_crafttable minecraft.used:minecraft.crafting_table
scoreboard objectives add smd_rightClick minecraft.used:minecraft.carrot_on_a_stick
