...
execute if score distance con matches ..512 if block ^ ^ ^0.125 #minecraft:air positioned ^ ^ ^0.125 run function smd:player/physic/raycast_test
#execute if score distance con matches ..160 unless block ^ ^ ^0.5 #minecraft:air positioned ^ ^ ^0.1 run function smd:event_listen/raycast_end
