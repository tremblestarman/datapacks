...
execute as @e[tag=force_add] store result entity @s Motion[0] double 0.00024 run scoreboard players get x2 var
execute as @e[tag=force_add] store result entity @s Motion[1] double 0.00024 run scoreboard players get y2 var
execute as @e[tag=force_add] store result entity @s Motion[2] double 0.00024 run scoreboard players get z2 var
