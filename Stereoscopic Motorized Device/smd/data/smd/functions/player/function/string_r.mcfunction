...
execute at @a facing entity @e[tag=string_rm,limit=1] feet run function smd:player/function/drawstring_r
execute if entity @s[tag=smd_hit_r] if score @s cStringLengthR > @s lStringLengthR run function smd:player/function/takeback_r
execute if entity @s[tag=smd_hit_r] if score @s cStringLengthR <= @s lStringLengthR run scoreboard players operation @s lStringLengthR = @s cStringLengthR
