...
# mainhand weapon
data modify entity @e[type=item,sort=nearest,limit=1,tag=smd_disassemble] Item set from block ~ ~ ~ Items[{Slot:0b}].tag.MainHandWeapon
tag @e[tag=smd_disassemble] remove smd_disassemble

summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:stone",Count:1b},Tags:[smd_disassemble]}
# offhand weapon
data modify entity @e[type=item,sort=nearest,limit=1,tag=smd_disassemble] Item set from block ~ ~ ~ Items[{Slot:0b}].tag.OffHandWeapon
tag @e[tag=smd_disassemble] remove smd_disassemble

summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:stone",Count:1b},Tags:[smd_disassemble]}
# compressed gas
data modify entity @e[type=item,sort=nearest,limit=1,tag=smd_disassemble] Item set from block ~ ~ ~ Items[{Slot:0b}].tag.CompressedGas
execute store result score mb var run data get block ~ ~ ~ Items[{Slot:0b}].tag.CompressedGas.tag.MB
...
summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:stone",Count:1b},Tags:[smd_disassemble]}
# compressed air
data modify entity @e[type=item,sort=nearest,limit=1,tag=smd_disassemble] Item set from block ~ ~ ~ Items[{Slot:0b}].tag.CompressedAir
execute store result score mb var run data get block ~ ~ ~ Items[{Slot:0b}].tag.CompressedAir.tag.MB
...
summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:stone",Count:1b},Tags:[smd_disassemble]}
# core
data modify entity @e[type=item,sort=nearest,limit=1,tag=smd_disassemble] Item set from block ~ ~ ~ Items[{Slot:0b}].tag.Core
tag @e[tag=smd_disassemble] remove smd_disassemble
