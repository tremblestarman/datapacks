...
# mainhand weapon
data modify entity @e[type=item,sort=nearest,limit=1,tag=smd_disassemble] Item set from block ~ ~ ~ Items[{Slot:4b}].tag.MainHandWeapon
tag @e[tag=smd_disassemble] remove smd_disassemble

summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:stone",Count:1b},Tags:[smd_disassemble]}
# offhand weapon
data modify entity @e[type=item,sort=nearest,limit=1,tag=smd_disassemble] Item set from block ~ ~ ~ Items[{Slot:4b}].tag.OffHandWeapon
tag @e[tag=smd_disassemble] remove smd_disassemble

summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:stone",Count:1b},Tags:[smd_disassemble]}
# compressed gas
data modify entity @e[type=item,sort=nearest,limit=1,tag=smd_disassemble] Item set from block ~ ~ ~ Items[{Slot:4b}].tag.CompressedGas
...
summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:stone",Count:1b},Tags:[smd_disassemble]}
# compressed air
data modify entity @e[type=item,sort=nearest,limit=1,tag=smd_disassemble] Item set from block ~ ~ ~ Items[{Slot:4b}].tag.CompressedAir
...
summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:stone",Count:1b},Tags:[smd_disassemble]}
# core
data modify entity @e[type=item,sort=nearest,limit=1,tag=smd_disassemble] Item set from block ~ ~ ~ Items[{Slot:4b}].tag.Core
tag @e[tag=smd_disassemble] remove smd_disassemble
